...
function share_to(m) {
	if (m == "baidu") {
		...
		void ((function(s, d, e) {
			...
			var f = 'http://service.t.sina.com.cn/share/share.php?', u = d.location.href, p = [
					'url=', e(u), '&title=', e(d.title), '&appkey=%E4%B8%AD%E5%9B%BD%E5%A4%A9%E6%B0%94%E7%BD%91','&pic=&ralateUid=1498396803' ]
					.join('');
			function a() {
				if (!window
						.open(
		...
		void ((function(s, d, e) {
			var f = 'http://t.sohu.com/third/post.jsp?&', u = d.location, p = [
					'url=', e(u), '&title=', e(d.title),'&content=utf-8&pic=' ]
					.join('');
;
			function a() {
				if (!window
		...
		(function() {
			var url = 'link=http://www.weather.com.cn/&source='
					+ encodeURIComponent('涓浗澶╂皵缃&#145;') + '&info='
					+ encodeURIComponent(document.title) + ' '
					+ encodeURIComponent(document.location.href);
			window
					.open(
...
function st_addBookmark(title){
 ...
 function postToWb(){
		...
		//var _pic = encodeURI('http://61.4.185.47/weibo/1277256_files/9085E5205845F86DDF2636B1A5AE2B9C.jpg');
